 ...
 * @author אליצור
 */
public class AlternativeClient implements Runnable {
     ...
     * @param fileName
     */
    public AlternativeClient(int R1, int R2, String fileName) {
        this.R1 = R1;
        this.R2 = R2;
        file = fileName;
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 1; i <= Integer.parseInt(args[3]); i++) {
                String nameOfFile = "C:\\Users\\yaron\\Documents\\NetBeansProjects\\OS1\\OS1\\ProbabilityFiles\\" + args[2] + ".txt";
                ...
                new Thread(new AlternativeClient(r1, r2, nameOfFile)).start();
            }
        } catch (FileNotFoundException ex) {
            Logger.getLogger(AlternativeClient.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(AlternativeClient.class.getName()).log(Level.SEVERE, null, ex);
        }
